...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <nav class="text-center text-white space-x-4 my-10 ">
	<button class="text-white bg-green-700 hover:bg-green-800 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
      <router-link :to="{ name:'home'}">Home</router-link>
      </button>
      <router-link :to="{ name:'about'}">
	<button  class="text-white bg-green-700 hover:bg-green-800 focus:text-blue font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 ">About
      </button>
      </router-link>
    </nav>
</template>
